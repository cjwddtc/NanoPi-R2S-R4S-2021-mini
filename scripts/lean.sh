...
wget -O- https://www.cooluc.com/openwrt/PATCH/new/main/r8168-fix_LAN_led-for_r4s-from_TL.patch | patch -p1
...
curl -s  https://www.cooluc.com/openwrt/patch/R4S/files/etc/board.d/01_leds > target/linux/rockchip/armv8/base-files/etc/board.d/01_leds
curl -s  https://www.cooluc.com/openwrt/patch/R4S/files/etc/board.d/02_network > target/linux/rockchip/armv8/base-files/etc/board.d/02_network
...
curl -s  https://www.cooluc.com/openwrt/patch/new/main/991-rockchip-rk3399-overclock-to-2.2-1.8-GHz-for-NanoPi4.patch >./target/linux/rockchip/patches-5.4/991-rockchip-rk3399-overclock-to-2.2-1.8-GHz-for-NanoPi4.patch
curl -s  https://www.cooluc.com/openwrt/patch/new/main/213-RK3399-set-critical-CPU-temperature-for-thermal-throttling.patch >./target/linux/rockchip/patches-5.4/213-RK3399-set-critical-CPU-temperature-for-thermal-throttling.patch
